...
query = query + "create table roles( actor_id int default NULL, moive_id int default NULL, role varchar(100) default NULL);\n"
query = query + "CREATE TABLE movies_directors( director_id int default NULL, movie_id int default NULL);\n"
query = query + "create TABLE movie_genres(movie_id int default NULL, genre varchar(100) default NULL);\n"
query = query + "create TABLE directors_genres(director_id int default NULL, genre varchar(100) default NULL, prob float default NULL);"
queryUpdate(query)
