...
with psycopg2.connect("hostaddr=139.147.9.154 port=5432 dbname=program user=grp1admin") as conn:

    # Open a cursor to perform database operations
    with conn.cursor() as cur:
        # Query the database and obtain data as Python objects.
        query = "copy" + " movies FROM STDIN WITH DELIMITER',' CSV QUOTE '''' ESCAPE '\\' NULL as 'NULL';\n"
        ...
        #cur.execute(query)
        cur.copy_expert(query, open("/home/grp1admin/csvData/imdb_movies.csv", "r"))
